...
<head>
    ...
    <link rel="stylesheet" href="/thinphp/Public/css/bootstrap.css" type="text/css"/>
    <link rel="stylesheet" href="/thinphp/Public/css/animate.css" type="text/css"/>
    <link rel="stylesheet" href="/thinphp/Public/css/font-awesome.min.css" type="text/css"/>
    <link rel="stylesheet" href="/thinphp/Public/css/font.css" type="text/css"/>
    <link rel="stylesheet" href="/thinphp/Public/js/calendar/bootstrap_calendar.css" type="text/css"/>
    <link rel="stylesheet" href="/thinphp/Public/js/jvectormap/jquery-jvectormap-1.2.2.css" type="text/css"/>
    <link rel="stylesheet" href="/thinphp/Public/css/app.css" type="text/css"/>
    <!--[if lt IE 9]>
...
<section class="vbox">
    <header class="bg-black dk header navbar navbar-fixed-top-xs">
        <div class="navbar-header aside-md">
            ...
            <a href="#" class="navbar-brand" data-toggle="fullscreen"><img src="/thinphp/Public/images/logo.png" class="m-r-sm"><?php echo v('config.webname');?></a>
        ...
        <ul class="nav navbar-nav navbar-right m-n hidden-xs nav-user">
            <li class="hidden-xs">
                ...
                <section class="dropdown-menu aside-xl">
                  ...
                  <span class="pull-left thumb-sm">
                    <img src="/thinphp/Public/images/avatar.jpg" alt="John said" class="img-circle">
                  </span>
            ...
            <span class="thumb-sm avatar pull-left">
              <img src="/thinphp/Public/images/avatar.jpg">
            </span>
                    向军 <b class="caret"></b>
                </a>
                    ...
                    <section class="w-f scrollable">
                        <div class="slim-scroll" data-height="auto" data-disable-fade-out="true" data-distance="0" data-size="5px" data-color="#333333">
                          ...
                          <i class="fa fa-angle-up text-active"></i>
                                        ...
                                        <ul class="nav lt">
                                            <li>
                                                <a href="<?php echo U('config/set');?>">
                                                    <i class="fa fa-angle-right"></i>
                                                    <span>网站配置</span>
                                                </a>
                                            </li>
                                            <li class="active">
                                                <a href="<?php echo U('wx/set');?>" class="active">
                                                    <i class="fa fa-angle-right"></i>
                                                    <span>公众号配置</span>
                                                </a>
                                            </li>
        ...
        <section class="panel panel-default">
            ...
            <div class="panel-body">
                <form role="form" action="" method="post">
                    ...
                    <input type="hidden" name="data" value="{{field}}">
...
<script>
    function controller($scope,util,_) {
        $scope.field=<?php echo $field?$field['data']:'{}'?>;
    }
</script>
                    </section>
                </section>
